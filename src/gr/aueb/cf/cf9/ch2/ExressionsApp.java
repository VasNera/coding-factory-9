...
public class ExressionsApp
{
    public static void main(String[] args) {
        ...
        sub = num1 - num2;
        mul = num1 * num2;
        div = num1 / num2;      // Η διαίρεση ακέραιων δίνει πάντα ακέραιο
        mod = num1 % num2;      // Το υπόλοιπο της διαίρεσης

        System.out.printf("Sum: %d, Sub: %d, Mul: %d, Div: %d, Mod: %d\n ", sum, sub, mul, div, mod);
        result1 = result1 + 1; // Αλλάζει η τιμή του result1
        result2+= 1;          // result2 = result2 + 1
        result3++;            // result 3 = result 3 + 1, result3 +=1
